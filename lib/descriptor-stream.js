...
var DescriptorStream = function (_EventEmitter) {
    ...
    function DescriptorStream(transport) {
        ...
        _this.failedToFetchTries = 0;
        _this.failedToFetchTriesLimit = 1;
        _this.previous = null;
        _this.current = [];
    ...
    _createClass(DescriptorStream, [{
        ...
        value: function listen() {
            ...
            promise.then(function (descriptors) {
                ...
                if (error && error.message === 'Failed to fetch' && _this2.failedToFetchTries < _this2.failedToFetchTriesLimit) {
                    // Try again. This error could be thrown by fetch API when computer goes to sleep and pending request is cancelled
                    _this2.failedToFetchTries++;
                    if (_this2.listening) {
                        _this2.listen();
                    }
                } else {
