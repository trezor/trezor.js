...
export class CallHelper {
    ...
    call(type: string, msg_: ?Object): Promise<DefaultMessageResponse> {
        const msg = msg_ == null ? {} : msg_;
    ...
    callSync(type: string, msg_: ?Object): DefaultMessageResponse {
        const msg = msg_ == null ? {} : msg_;
    ...
    typedCall(type: string, resType: string, msg_: ?Object): Promise<DefaultMessageResponse> {
        const msg = msg_ == null ? {} : msg_;
