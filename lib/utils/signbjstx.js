...
function input2trezor(input: InputInfo): types.TransactionInput {
...
function output2trezor(output: OutputInfo, network: bitcoin.Network): types.TransactionOutput {
...
function signedTx2refTx(signedTx: MessageResponse<types.SignedTx>): bitcoin.Transaction {
