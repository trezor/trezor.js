...
export default class UnacquiredDevice extends EventEmitter {
    ...
    steal(): Promise {
        ...
        const currentSession: ?string = this.deviceList.getSession(this.originalDescriptor.path);
        const descriptor = Object.assign({}, this.originalDescriptor);
        descriptor.session = currentSession;
        Device._run(() => {
            return true;
