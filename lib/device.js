...
export default class Device extends EventEmitter {
    ...
    clearSessionRestTimeout: ?number = null;
    ...
    _startClearSessionTimeout() {
        ...
        this.clearSessionRestTimeout = window.setTimeout(() => {
            this.clearSessionRest = this.clearSessionRest - 1;
        });
    }
    ...
    _stopClearSessionTimeout() {
        ...
        if (this.clearSessionRestTimeout != null) {
            window.clearTimeout(this.clearSessionRestTimeout);
            this.clearSessionRestTimeout = null;
        }
    }
