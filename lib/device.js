...
export default class Device extends EventEmitter {
    ...
    run<X>(fn: (session: Session) => (X|Promise<X>), options: ?{
        ...
        return waitingPromise.then((resolvedSession: ?string) => {
            const descriptor: DeviceDescriptor = Object.assign({}, this.originalDescriptor);
            descriptor.session = resolvedSession;
            return Device._run(
    ...
    static fromDescriptor(
        ...
        const descriptor: DeviceDescriptor = Object.assign({}, originalDescriptor);
        descriptor.session = null; // at this point I am assuming nobody else has the device
