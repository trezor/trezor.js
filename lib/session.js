...
export default class Session extends EventEmitter {
    ...
    resetDevice(settings: trezor.ResetDeviceSettings): Promise<DefaultMessageResponse> {
    ...
    recoverDevice(settings: trezor.RecoverDeviceSettings): Promise<DefaultMessageResponse> {
    ...
    applySettings(settings: trezor.ApplySettings): Promise<DefaultMessageResponse> {
