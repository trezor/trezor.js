...
export default class Session extends EventEmitter {
    ...
    initialize(): Promise<types.MessageResponse<types.Features>> {
        return this._typedCall('Initialize', 'Features');
    }

    getFeatures(): Promise<types.MessageResponse<types.Features>> {
        return this._typedCall('GetFeatures', 'Features');
    }

    getEntropy(size: number): Promise<types.MessageResponse<{bytes: string}>> {
        return this._typedCall('GetEntropy', 'Entropy', {
            size: size,
        });
    }
    ...
    getAddress(address_n: Array<number>, coin: types.CoinType, show_display: ?boolean): Promise<types.MessageResponse<{
        ...
        return this._typedCall('GetAddress', 'Address', {
            address_n: address_n,
    ...
    getPublicKey(address_n: Array<number>): Promise<types.MessageResponse<types.PublicKey>> {
        return this._typedCall('GetPublicKey', 'PublicKey', {
            address_n: address_n,
        }).then(res => {
    ...
    wipeDevice(): Promise<types.DefaultMessageResponse> {
        return this._typedCall('WipeDevice', 'Success');
    }

    resetDevice(settings: types.ResetDeviceSettings): Promise<types.DefaultMessageResponse> {
        return this._typedCall('ResetDevice', 'Success', settings);
    }
    ...
    loadDevice(
        ...
        return this._typedCall('LoadDevice', 'Success', wrapLoadDevice(settings, network));
    }
    ...
    recoverDevice(settings: types.RecoverDeviceSettings): Promise<types.DefaultMessageResponse> {
        ...
        return this._typedCall('RecoveryDevice', 'Success', settings);
    }

    applySettings(settings: types.ApplySettings): Promise<types.DefaultMessageResponse> {
        return this._typedCall('ApplySettings', 'Success', settings);
    }

    clearSession(settings?: {}): Promise<types.DefaultMessageResponse> {
        return this._typedCall('ClearSession', 'Success', settings);
    }
    ...
    changePin(remove: ?boolean): Promise<types.DefaultMessageResponse> {
        return this._typedCall('ChangePin', 'Success', {
            remove: remove || false,
        });
    }

    eraseFirmware(): Promise<types.DefaultMessageResponse> {
        return this._typedCall('FirmwareErase', 'Success');
    }

    // payload is in hexa
    uploadFirmware(payload: string): Promise<types.DefaultMessageResponse> {
        return this._typedCall('FirmwareUpload', 'Success', {
            payload: payload,
        });
    }
    ...
    verifyMessage(address: string, signature: string, message: string): Promise<types.DefaultMessageResponse> {
        return this._typedCall('VerifyMessage', 'Success', {
            address: address,
            signature: signature,
            message: message,
        });
    ...
    signMessage(address_n: Array<number>, message: string, coin: types.CoinType): Promise<types.MessageResponse<types.MessageSignature>> {
        return this._typedCall('SignMessage', 'MessageSignature', {
            address_n: address_n,
            message: message,
            coin_name: coin.coin_name,
        });
    ...
    signIdentity(
        ...
        return this._typedCall('SignIdentity', 'SignedIdentity', {
            identity: identity,
    ...
    cipherKeyValue(
        ...
        return this._typedCall('CipherKeyValue', 'CipheredKeyValue', {
            address_n: address_n,
            key: key,
            value: valueString,
            encrypt: encrypt,
    ...
    measureTx(
        ...
        return this._typedCall('EstimateTxSize', 'TxSize', {
