...
type DefaultMessageResponse = MessageResponse<Object | string>;
...
export default class Session extends EventEmitter {
    ...
    // Blocks the browser thread, be careful.
    clearSessionSync(settings: ?{}): Promise<DefaultMessageResponse> {
    ...
    measureTx(inputs: FixLater, outputs: FixLater, coin: CoinType) {
    ...
    signTx(inputs: Array<FixLater>, outputs: Array<FixLater>, txs: Array<FixLater>, coin: CoinType) {
