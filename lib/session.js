...
export default class Session extends EventEmitter {
    ...
    // indexes previous transactions for quick lookup
    _indexTxsForSign(
    ...
    _requestTxInfo(
        ...
        if (md.tx_hash) {
            ...
            return this._requestPrevTxInfo(
                reqTx,
                m.request_type,
                md.request_index
            );
        } else {
            return this._requestSignedTxInfo(inputs, outputs, m.request_type, md.request_index);
        }
    }
    ...
    _processTxRequest(
        ...
        this._saveTxSignatures(m.serialized, serializedTx, signatures);
        ...
        const resTx = this._requestTxInfo(m, index, ins, outs);
    ...
    signTx(
        ...
        const index: {[key: string]: RefTransaction} = this._indexTxsForSign(txs);
