...
export default class Session extends EventEmitter {
    ...
    initialize(): Promise<MessageResponse<types.Features>> {
        return this.typedCall('Initialize', 'Features');
    }

    getFeatures(): Promise<MessageResponse<types.Features>> {
    ...
    getAddress(address_n: Array<number>, coin: types.CoinType | string, show_display: ?boolean): Promise<MessageResponse<{
        address: string;
        path: Array<number>;
    }>> {
    ...
    getPublicKey(address_n: Array<number>): Promise<MessageResponse<types.PublicKey>> {
    ...
    resetDevice(settings: types.ResetDeviceSettings): Promise<DefaultMessageResponse> {
    ...
    recoverDevice(settings: types.RecoverDeviceSettings): Promise<DefaultMessageResponse> {
    ...
    applySettings(settings: types.ApplySettings): Promise<DefaultMessageResponse> {
    ...
    signMessage(address_n: Array<number>, message: string, coin: types.CoinType | string): Promise<MessageResponse<types.MessageSignature>> {
    ...
    ): Promise<MessageResponse<types.SignedIdentity>> {
    ...
    ): Promise<MessageResponse<types.SignedTx>> {
