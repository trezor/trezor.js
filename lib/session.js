...
export default class Session extends EventEmitter {
    ...
    getAddress(address_n: Array<number>, coin: {coin_name: string}, show_display: ?boolean): Promise<{
        message: {
            address: string;
            path: Array<number>;
        }
    ...
    clearSession(settings: ?{}): Promise<void> {
        return this._commonCall('ClearSession', settings);
    }

    // Blocks the browser thread, be careful.
    clearSessionSync(settings: ?{}): Promise<void> {
    ...
    // payload is in hexa
    uploadFirmware(payload: string): Promise<void> {
    ...
    signTx(inputs: Array<FixLater>, outputs: Array<FixLater>, txs: Array<FixLater>, coin: {coin_name: string}) {
